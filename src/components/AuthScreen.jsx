        ...
        <div className="auth-screen">
            <div className="auth-card card">
                ...
                <p className="auth-switch">
                    ...
                    <button className="auth-switch-btn" onClick={() => setIsSignup(!isSignup)} type="button">
                        {isSignup ? 'Sign In' : 'Sign Up'}
                    </button>
                </p>

                <p className="auth-skip text-muted" style={{ marginTop: 'var(--spacing-2)', fontSize: '0.8rem' }}>
